...
class TestSlack:
    ...
    def test_method_create(self, client: Cloneforce) -> None:
        slack = client.v1.clones.integrations.slack.create(
            "cloneId",
        )
        assert_matches_type(SlackIntegration, slack, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_create(self, client: Cloneforce) -> None:
        response = client.v1.clones.integrations.slack.with_raw_response.create(
            "cloneId",
        )
    ...
    def test_streaming_response_create(self, client: Cloneforce) -> None:
        with client.v1.clones.integrations.slack.with_streaming_response.create(
            "cloneId",
        ) as response:
    ...
    def test_path_params_create(self, client: Cloneforce) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `clone_id` but received ''"):
            client.v1.clones.integrations.slack.with_raw_response.create(
                "",
            )
    ...
    def test_method_update(self, client: Cloneforce) -> None:
        slack = client.v1.clones.integrations.slack.update(
    ...
    def test_raw_response_update(self, client: Cloneforce) -> None:
        response = client.v1.clones.integrations.slack.with_raw_response.update(
            integration_id="integrationId",
            clone_id="cloneId",
        )
    ...
    def test_streaming_response_update(self, client: Cloneforce) -> None:
        with client.v1.clones.integrations.slack.with_streaming_response.update(
            integration_id="integrationId",
            clone_id="cloneId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Cloneforce) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `clone_id` but received ''"):
            client.v1.clones.integrations.slack.with_raw_response.update(
                integration_id="integrationId",
                clone_id="",
            )
...
class TestAsyncSlack:
    ...
    async def test_method_create(self, async_client: AsyncCloneforce) -> None:
        slack = await async_client.v1.clones.integrations.slack.create(
            "cloneId",
        )
        assert_matches_type(SlackIntegration, slack, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncCloneforce) -> None:
        response = await async_client.v1.clones.integrations.slack.with_raw_response.create(
            "cloneId",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncCloneforce) -> None:
        async with async_client.v1.clones.integrations.slack.with_streaming_response.create(
            "cloneId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncCloneforce) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `clone_id` but received ''"):
            await async_client.v1.clones.integrations.slack.with_raw_response.create(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncCloneforce) -> None:
        slack = await async_client.v1.clones.integrations.slack.update(
            integration_id="integrationId",
            clone_id="cloneId",
        )
        assert_matches_type(SlackIntegration, slack, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncCloneforce) -> None:
        response = await async_client.v1.clones.integrations.slack.with_raw_response.update(
            integration_id="integrationId",
            clone_id="cloneId",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCloneforce) -> None:
        async with async_client.v1.clones.integrations.slack.with_streaming_response.update(
            integration_id="integrationId",
            clone_id="cloneId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncCloneforce) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `clone_id` but received ''"):
            await async_client.v1.clones.integrations.slack.with_raw_response.update(
                integration_id="integrationId",
                clone_id="",
            )
