...
from ....types.v1.clones import file_create_params
from ....types.v1.clones.kb_file_summary import KBFileSummary
from ....types.v1.clones.file_list_response import FileListResponse
from ....types.v1.clones.file_delete_response import FileDeleteResponse
...
class FilesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/clones/{clone_id}/files",
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/api/v1/clones/{clone_id}/files/{file_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=KBFileSummary,
