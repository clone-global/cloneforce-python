...
class GalleryResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/public/v1/clones/{clone_id}/gallery", clone_id=clone_id),
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/public/v1/clones/{clone_id}/gallery/{item_id}", clone_id=clone_id, item_id=item_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=GalleryItemSummary,
